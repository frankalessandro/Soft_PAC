        ...
        .then(respuestaJson => {
            ...
            if (respuestaJson.rpta) {
                respuestaJson.rpta.forEach(usuario => {
                    ...
                    <th scope="row" class="flex gap-2 justify-center text-left px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            <svg class="w-10 h-10 rounded-full text-gray-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
