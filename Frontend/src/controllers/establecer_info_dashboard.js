...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (usuario.idRol == 1 || usuario.idRol == 2 ) {
    idRol.innerHTML = `
      <li>
        <a href="#" onclick="handleOptionClick('Dashboard')" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-color-base-hover  dark:hover:bg-color-base group">
